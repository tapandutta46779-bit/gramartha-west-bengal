...
CATEGORIES = {
    ("amenity", "cafe"): "TEA_OR_SWEET_SHOP",
    ...
    ("shop", "butcher"): "FOOD_SHOP",
    ("shop", "confectionery"): "TEA_OR_SWEET_SHOP",
    ("shop", "convenience"): "FOOD_SHOP",
    ("shop", "dairy"): "DAIRY",
    ("shop", "deli"): "FOOD_SHOP",
    ("shop", "department_store"): "SUPERMARKET",
    ("shop", "electrical"): "ELECTRONICS_SHOP",
    ("shop", "electronics"): "ELECTRONICS_SHOP",
    ("shop", "farm"): "AGRI_INPUT_SHOP",
    ("shop", "frozen_food"): "FOOD_SHOP",
    ("shop", "general"): "GENERAL_SHOP",
    ("shop", "greengrocer"): "FOOD_SHOP",
    ("shop", "grocery"): "FOOD_SHOP",
    ("shop", "hardware"): "HOUSEHOLD_SHOP",
    ("shop", "houseware"): "HOUSEHOLD_SHOP",
    ("shop", "kiosk"): "GENERAL_SHOP",
    ("shop", "mall"): "MARKET",
    ("shop", "mobile_phone"): "ELECTRONICS_SHOP",
    ("shop", "pastry"): "TEA_OR_SWEET_SHOP",
    ("shop", "seafood"): "FOOD_SHOP",
    ("shop", "spices"): "FOOD_SHOP",
    ("shop", "supermarket"): "SUPERMARKET",
    ("shop", "tea"): "TEA_OR_SWEET_SHOP",
    ("shop", "variety_store"): "GENERAL_SHOP",
    ("shop", "yes"): "GENERAL_SHOP",
    ("shop", "agrarian"): "AGRI_INPUT_SHOP",
    ("shop", "appliance"): "HOUSEHOLD_SHOP",
    ("shop", "computer"): "ELECTRONICS_SHOP",
    ("shop", "furniture"): "HOUSEHOLD_SHOP",
}
...
def create_database(
    ...
    metadata = {
        ...
        "extractor_version": "WB_OSM_SQLITE_V3_EXPANDED_BUSINESS_TAGS",
