...
COMMON_RETAIL_DIRECT = frozenset({"GENERAL_SHOP", "SUPERMARKET", "FOOD_SHOP"})
COMMON_MARKET_INDIRECT = frozenset({"MARKET"})
...
REGISTRY = {
    ...
    "poultry": SectorFactors(
        ...
        frozenset({"FOOD_SHOP", "MARKET", "GENERAL_SHOP"}),
        frozenset({"RESTAURANT", "SUPERMARKET"}),
    ...
    "food_processing": SectorFactors(
        ...
        frozenset({"SUPERMARKET", "RESTAURANT"}),
    ...
    "electronics_mobile": SectorFactors(
        ...
        frozenset({"GENERAL_SHOP", "SUPERMARKET"}),
        frozenset({"MARKET"}),
    ...
    "dairy": SectorFactors(
        ...
        frozenset({"GENERAL_SHOP", "SUPERMARKET", "TEA_OR_SWEET_SHOP"}),
